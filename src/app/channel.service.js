...
var ChannelService = (function () {
    function ChannelService(http) {
        ...
        this.channelsUrl = 'api/channels'; // URL to web api
    }
    ...
    ChannelService.prototype.getChannel = function (id) {
        var url = this.channelsUrl + "/" + id;
        return this.http.get(url)
            .toPromise()
            .then(function (response) { return response.json().data; })
            .catch(this.handleError);
    };
    ChannelService.prototype.delete = function (id) {
        var url = this.channelsUrl + "/" + id;
    ...
    ChannelService.prototype.create = function (name) {
        return this.http
    ...
    ChannelService.prototype.update = function (channel) {
        var url = this.channelsUrl + "/" + channel.id;
        return this.http
